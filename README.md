...
This repo helps me learn front-end basics (HTML/CSS/JS) through two simple
examples:
...
1. Open either HTML file with Live Server (VS Code extension) or by dragging it
   into a browser.
2. Update `styles.css` to try new layouts, spacing, fonts, etc.
<!-- 3. Use `scripts.js` to prototype JavaScript behavior (e.g., expand/collapse
   sections, highlight timeline entries). -->
